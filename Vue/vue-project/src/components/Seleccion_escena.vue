...
<template>
    ...
    <h3>Selección por color (GPU picking)</h3>
    <p>Primero, se crea una estructura de datos que almacene cada objeto con un color asociado. Cada uno tiene
        que tener un color distinto. </p>
    <p>Se renderiza la escena y con el puntero se selecciona un punto de la venta.</p>
    <p>Luego se redibujan los objetos aplicando su color asociado sin aplicar sombreados, es decir se desactivan
         las luces para no alterar el color de los objetos. De esta manera se puede procesar el color del 
         pixel seleccionado.</p>
    <p>Por último, se busca en el buffer el objeto asociado a ese color, y se renderiza la escena con
